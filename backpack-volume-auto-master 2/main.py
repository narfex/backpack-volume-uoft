...
def bot_info(name: str = ""):
    ...
    print(
        f"{colored('NEVO <crypto/> moves:', color='light_yellow')} "
        f"{colored('https://chat.whatsapp.com/DxXEEwlLCVWAQtcvlB18YR', color='light_green')}"
    )
    print(
        f"{colored('To say thanks for work:', color='light_yellow')} "
        f"{colored('0x335e9d6113ca3aef7eebcb24e210d82d8b732515', color='light_green')}"
    )
